...
def all_supplies_in_holidays(holiday_hash)
  ...
  holiday_hash.each do |season, days|
    ...
    days.each do |day, array|
   
      puts "  #{day.to_s.split("_").collect {
        |cap| cap.capitalize}.join(" ")
      }: #{array.join(", ")}"
